...
namespace cob_cartesian_controller
{
  ...
  class CartesianControllerActionFeedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "cob_cartesian_controller/CartesianControllerActionFeedback"; };
    virtual const char * getMD5() override { return "bbe8687d89865b3ef5b686e27612ae4a"; };
