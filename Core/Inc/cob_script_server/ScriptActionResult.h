...
namespace cob_script_server
{
  ...
  class ScriptActionResult : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "cob_script_server/ScriptActionResult"; };
    virtual const char * getMD5() override { return "363a8255aae19ae465319475e1a86dad"; };
