...
namespace cob_script_server
{
  ...
  class StateActionResult : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "cob_script_server/StateActionResult"; };
    virtual const char * getMD5() override { return "ce13060ab8a677de81822b61b38a1956"; };
